...
<nav>
            ...
            <label for="aboutUsTrigger" 
                   style="cursor: pointer; color: white;  font-size: 16px; transition: color 0.3s ease, text-decoration 0.3s ease;" 
    ...
    <main>
        ...
        <section class="games">
            <div class="game" style="background-image: url('trivia game.jfif'); background-size: cover; background-position: center;">
                ...
                <a href="game1.jsp" style="position: absolute; top: 750px; left: 200px;">Start Game</a>
            </div>
            ...
            <div class="game" style="background-image: url('snakeimg.png'); background-size: cover; background-position: center;">
                ...
                <a href="game.jsp" style="position: absolute; top: 750px; left: 665px;">Start Game</a>
            </div>
            ...
            <div class="game" style="background-image: url('rockimg1.jpg'); background-size: 130%; background-position: center;">
                ...
                <a href="rockPaperScissors.jsp" style="position: absolute; top: 750px; left: 1120px;">Start Game</a>
            </div>
            ...
            <div class="game" style="background-image: url('guessimg.jfif'); background-size: 180%; background-position: -116px -30px;">
                ...
                <a href="guessTheNumber.jsp" style="position: absolute; top: 750px; left: 1582px;">Start Game</a>
            </div>
            
             <div class="game1" style="background-image: url('jumpingimg.jpg'); background-size: 160%; background-position: -95px -50px;">
                <h3 style="margin-top: -5%;">jumping game</h3>
                <a href="jumping.jsp" style="position: absolute; top: 1270px; left: 200px;">Start Game</a>
            </div>
 ...
 <div class="game1" style="background-image: url('pencil4.png'); background-size: 130%; background-position:-40px 10px;;">
    ...
    <a href="draw.jsp" style="position: absolute; bottom: -390px; left: 660px;">Start Game</a>
</div>
 
            <div class="game1" style="background-image: url(''); background-size: 160%; background-position: center;">
                <h3 style="margin-top: -5%;">Car game</h3>
                <a href="car.jsp" style="top: 1270px; left: 500px;">Start Game</a>
            </div>
    ...
    <script>
        function searchGame() {
            ...
            if(query) {
                ...
                // Here you could add logic to filter or show relevant games based on the search query
            } else {
